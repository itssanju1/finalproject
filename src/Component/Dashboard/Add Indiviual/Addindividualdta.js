    ...
    <Container fluid>
      <Row>
        ...
        <Col md={9} >
          ...
          <div className='addindividualmid'>
          <Row style={{marginLeft:'3vh',marginTop:'5vh'}}>
            ...
            <div style={{ width: '20rem',height:'15em' }} className='containercssdashboard'>
             ...
             <LinkContainer to={"/Personalinformation"} ><button className='buttondashboardcss1'>Complete</button></LinkContainer>
            </div>
            ...
            <div style={{ width: '20rem',height:'15em' }} className='containercssdashboard1'>
             ...
             <LinkContainer to={"/Creditdocumentinformation"} ><button className='buttondashboardcss1'>Complete</button></LinkContainer>
            </div>
            ...
            <div style={{ width: '20rem',height:'15em' }} className='containercssdashboard1'>
             ...
             <LinkContainer to={"/Medicaldeclation"} ><button className='buttondashboard1'>Complete</button></LinkContainer>
            </div>
            </Row>
            <Row style={{marginLeft:'3vh',marginTop:'5vh'}}>
            <div style={{ width: '20rem',height:'15em' }} className='containercssdashboard2'>
             ...
             <LinkContainer to={"/Policydocument"} ><button className='buttondashboardcss1'>Complete</button></LinkContainer>
            </div>
            </Row>
            </div>
...
export default Addindividualdta