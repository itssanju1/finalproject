    ...
    return (
        ...
        <Container fluid>
            <Row>
                <Col md={3}></Col>
                <Col md={9}>
                    <div className='cancelledcss'>
                        Dashboard <ArrowForwardIosIcon className='arrowcss' /> Add Individual <ArrowForwardIosIcon className='arrowcss' /> Credit Document           <NotificationsIcon style={{ fontSize: 40 }} className='cancellednotification' />
                        <img src={pic} className='piccss'></img>
                    </div>
                    <div className='cancelledcss1'>
                        Upload Cancelled Cheque
                    </div>
                    <div className='cancelleddiv1'>
                    <div className='cancelleddiv2'>
                    <div className='cancelledcss2'>
                        <Row>
                            <Col md={10}>
                        ...
                        <LinkContainer to={'/Addindividual'}><button className='cancelledbutton'>Save and Next</button></LinkContainer>
...
export default Cancelledcheque