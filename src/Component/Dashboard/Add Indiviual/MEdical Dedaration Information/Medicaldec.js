    ...
    return (
        ...
        <Container fluid>
            <Row>
                <Col md={3}></Col>
                <Col md={9}>
                    <div className='medicalcss1'>
                        Dashboard <ArrowForwardIosIcon className='arrowcss' /> Add Individual <ArrowForwardIosIcon className='arrowcss' /> Medical declaration
                        <NotificationsIcon style={{ fontSize: 40 }} className='medicalnotification' />
                        <img src={pic} className='piccss'></img>
                    </div>
                    <div className='medicalcss2'>
                        Medical declaration
                    </div>
                    <div className='medicaldivcss1'>
                    <div className='medicaldivcss2'>
                    <div className='medicalcss3'>
                        <Row>
                            <Col md={4}>
                        ...
                        <LinkContainer to={'/Addindividual'}><button className='medicalbuton'>Save and Next</button></LinkContainer>
